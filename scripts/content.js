...
class DataProcessor {
    ...
    processSearchResults() {
        ...
        let item = {
            ...
            CCCD: record.BU_OWNER ? record.BU_OWNER[0].IDNUMBER || '' : '',
            NGAY_CAP: record.BU_OWNER ? record.BU_OWNER[0].ENTRY_DATE || '' : '',
            NGAY_SINH: record.BU_OWNER ? record.BU_OWNER[0].NGAY_SINH || '' : '',
